...
namespace STORYGAME
{
    ...
    public class GameSystem : MonoBehaviour
    {
        ...
        public StoryTableObejct[] storyModels;
        public StoryTableObejct currentModels;


        private void Start()
        {
            currentModels = FindStoryModels(1);
            StartCoroutine(ShowText());
        }
        StoryTableObejct FindStoryModels(int number)
        {
            StoryTableObejct tempStoryModels = null;
        ...
        {
            storyModels = Resources.LoadAll<StoryTableObejct>("");
