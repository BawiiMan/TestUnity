...
namespace STORYGAME
{
    ...
    public class GameSystem : MonoBehaviour
    {
        ...
        public void StoryShow(int number)
        {
            ...
            //StorySystem.Instnace.currentStoryModel = tempStoryModels;
        ...
        public void ApplyChoice(StoryModel.Result result)       //스토리 선택시 결과
        {
            switch(result.resultType)
            {
                case StoryModel.Result.ResultType.ChangeHp:
                    ...
                    //GameUI.Instance.UpdateUI()    //나중에 추가
                    ChangeStats(result);
                    break;
        ...
        public void ChangeStats(StoryModel.Result result)               //상태 변경 함수
        {
            ...
            if (result.stats.constitution > 0) stats.constitution += result.stats.constitution;
        ...
        StoryModel RandomStory()                                                                                        //랜덤 스토리 리턴 함수
        {
